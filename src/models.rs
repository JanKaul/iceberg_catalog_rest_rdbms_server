...
impl std::str::FromStr for AddPartitionSpecUpdateAllOf {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing AddPartitionSpecUpdateAllOf".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "spec" => intermediate_rep.spec.push(<models::PartitionSpec as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing AddPartitionSpecUpdateAllOf".to_string())
                }
            }
        ...
        std::result::Result::Ok(AddPartitionSpecUpdateAllOf {
            spec: intermediate_rep.spec.into_iter().next().ok_or_else(|| "spec missing in AddPartitionSpecUpdateAllOf".to_string())?,
        })
    }
}
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<header::IntoHeaderValue<AddPartitionSpecUpdateAllOf>> for hyper::header::HeaderValue {
    type Error = String;

    fn try_from(hdr_value: header::IntoHeaderValue<AddPartitionSpecUpdateAllOf>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for AddPartitionSpecUpdateAllOf - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<AddPartitionSpecUpdateAllOf> {
    type Error = String;
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <AddPartitionSpecUpdateAllOf as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into AddPartitionSpecUpdateAllOf - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl std::str::FromStr for AddSchemaUpdateAllOf {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing AddSchemaUpdateAllOf".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "schema" => intermediate_rep.schema.push(<models::Schema as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing AddSchemaUpdateAllOf".to_string())
                }
            }
        ...
        std::result::Result::Ok(AddSchemaUpdateAllOf {
            schema: intermediate_rep.schema.into_iter().next().ok_or_else(|| "schema missing in AddSchemaUpdateAllOf".to_string())?,
        })
    }
}
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<header::IntoHeaderValue<AddSchemaUpdateAllOf>> for hyper::header::HeaderValue {
    type Error = String;

    fn try_from(hdr_value: header::IntoHeaderValue<AddSchemaUpdateAllOf>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for AddSchemaUpdateAllOf - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<AddSchemaUpdateAllOf> {
    type Error = String;
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <AddSchemaUpdateAllOf as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into AddSchemaUpdateAllOf - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl std::str::FromStr for AddSnapshotUpdateAllOf {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing AddSnapshotUpdateAllOf".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "snapshot" => intermediate_rep.snapshot.push(<models::Snapshot as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing AddSnapshotUpdateAllOf".to_string())
                }
            }
        ...
        std::result::Result::Ok(AddSnapshotUpdateAllOf {
            snapshot: intermediate_rep.snapshot.into_iter().next().ok_or_else(|| "snapshot missing in AddSnapshotUpdateAllOf".to_string())?,
        })
    }
}
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<header::IntoHeaderValue<AddSnapshotUpdateAllOf>> for hyper::header::HeaderValue {
    type Error = String;

    fn try_from(hdr_value: header::IntoHeaderValue<AddSnapshotUpdateAllOf>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for AddSnapshotUpdateAllOf - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<AddSnapshotUpdateAllOf> {
    type Error = String;
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <AddSnapshotUpdateAllOf as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into AddSnapshotUpdateAllOf - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl std::str::FromStr for AddSortOrderUpdateAllOf {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing AddSortOrderUpdateAllOf".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "sort-order" => intermediate_rep.sort_order.push(<models::SortOrder as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing AddSortOrderUpdateAllOf".to_string())
                }
            }
        ...
        std::result::Result::Ok(AddSortOrderUpdateAllOf {
            sort_order: intermediate_rep.sort_order.into_iter().next().ok_or_else(|| "sort-order missing in AddSortOrderUpdateAllOf".to_string())?,
        })
    }
}
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<header::IntoHeaderValue<AddSortOrderUpdateAllOf>> for hyper::header::HeaderValue {
    type Error = String;

    fn try_from(hdr_value: header::IntoHeaderValue<AddSortOrderUpdateAllOf>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for AddSortOrderUpdateAllOf - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<AddSortOrderUpdateAllOf> {
    type Error = String;
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <AddSortOrderUpdateAllOf as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into AddSortOrderUpdateAllOf - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "overrides" => intermediate_rep.overrides.push(<serde_json::Value as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "defaults" => intermediate_rep.defaults.push(<serde_json::Value as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
...
impl std::str::FromStr for CreateNamespace200Response {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing CreateNamespace200Response".to_string())
            };
        ...
        std::result::Result::Ok(CreateNamespace200Response {
            namespace: intermediate_rep.namespace.into_iter().next().ok_or_else(|| "namespace missing in CreateNamespace200Response".to_string())?,
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<header::IntoHeaderValue<CreateNamespace200Response>> for hyper::header::HeaderValue {
    type Error = String;

    fn try_from(hdr_value: header::IntoHeaderValue<CreateNamespace200Response>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for CreateNamespace200Response - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<CreateNamespace200Response> {
    type Error = String;
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <CreateNamespace200Response as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into CreateNamespace200Response - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl std::str::FromStr for GetToken200Response {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing GetToken200Response".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    #[allow(clippy::redundant_clone)]
                    "expires_in" => intermediate_rep.expires_in.push(<isize as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    ...
                    _ => return std::result::Result::Err("Unexpected key while parsing GetToken200Response".to_string())
                }
            }
        ...
        std::result::Result::Ok(GetToken200Response {
            access_token: intermediate_rep.access_token.into_iter().next().ok_or_else(|| "access_token missing in GetToken200Response".to_string())?,
            token_type: intermediate_rep.token_type.into_iter().next().ok_or_else(|| "token_type missing in GetToken200Response".to_string())?,
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<header::IntoHeaderValue<GetToken200Response>> for hyper::header::HeaderValue {
    type Error = String;

    fn try_from(hdr_value: header::IntoHeaderValue<GetToken200Response>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for GetToken200Response - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<GetToken200Response> {
    type Error = String;
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <GetToken200Response as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into GetToken200Response - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl std::str::FromStr for GetToken400Response {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing GetToken400Response".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    _ => return std::result::Result::Err("Unexpected key while parsing GetToken400Response".to_string())
                }
            }
        ...
        std::result::Result::Ok(GetToken400Response {
            error: intermediate_rep.error.into_iter().next().ok_or_else(|| "error missing in GetToken400Response".to_string())?,
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<header::IntoHeaderValue<GetToken400Response>> for hyper::header::HeaderValue {
    type Error = String;

    fn try_from(hdr_value: header::IntoHeaderValue<GetToken400Response>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for GetToken400Response - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<GetToken400Response> {
    type Error = String;
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <GetToken400Response as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into GetToken400Response - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl std::str::FromStr for ListNamespaces200Response {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing ListNamespaces200Response".to_string())
            };
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<header::IntoHeaderValue<ListNamespaces200Response>> for hyper::header::HeaderValue {
    type Error = String;

    fn try_from(hdr_value: header::IntoHeaderValue<ListNamespaces200Response>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for ListNamespaces200Response - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<ListNamespaces200Response> {
    type Error = String;
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <ListNamespaces200Response as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into ListNamespaces200Response - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl std::str::FromStr for ListTables200Response {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing ListTables200Response".to_string())
            };
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<header::IntoHeaderValue<ListTables200Response>> for hyper::header::HeaderValue {
    type Error = String;

    fn try_from(hdr_value: header::IntoHeaderValue<ListTables200Response>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for ListTables200Response - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<ListTables200Response> {
    type Error = String;
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <ListTables200Response as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into ListTables200Response - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl ListType {
    #[allow(clippy::new_without_default)]
    pub fn new(r#type: String, element_id: isize, element: models::Type, element_required: bool, ) -> ListType {
        ListType {
            r#type,
            element_id,
            element,
        ...
        while key_result.is_some() {
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    "type" => intermediate_rep.r#type.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "element-id" => intermediate_rep.element_id.push(<isize as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
...
impl std::str::FromStr for LoadNamespaceMetadata200Response {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing LoadNamespaceMetadata200Response".to_string())
            };
        ...
        std::result::Result::Ok(LoadNamespaceMetadata200Response {
            namespace: intermediate_rep.namespace.into_iter().next().ok_or_else(|| "namespace missing in LoadNamespaceMetadata200Response".to_string())?,
            properties: intermediate_rep.properties.into_iter().next(),
        })
    }
}
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<header::IntoHeaderValue<LoadNamespaceMetadata200Response>> for hyper::header::HeaderValue {
    type Error = String;

    fn try_from(hdr_value: header::IntoHeaderValue<LoadNamespaceMetadata200Response>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<LoadNamespaceMetadata200Response> {
    type Error = String;
...
impl MapType {
    #[allow(clippy::new_without_default)]
    pub fn new(r#type: String, key_id: isize, key: models::Type, value_id: isize, value: models::Type, value_required: bool, ) -> MapType {
        MapType {
            r#type,
            key_id,
            key,
        ...
        while key_result.is_some() {
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    "type" => intermediate_rep.r#type.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "key-id" => intermediate_rep.key_id.push(<isize as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "key" => intermediate_rep.key.push(<models::Type as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "value-id" => intermediate_rep.value_id.push(<isize as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
        ...
        while key_result.is_some() {
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    #[allow(clippy::redundant_clone)]
                    "timestamp-ms" => intermediate_rep.timestamp_ms.push(<isize as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "field-id" => intermediate_rep.field_id.push(<isize as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "source-id" => intermediate_rep.source_id.push(<isize as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "name" => intermediate_rep.name.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "spec-id" => intermediate_rep.spec_id.push(<isize as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
...
impl std::str::FromStr for RemovePropertiesUpdateAllOf {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing RemovePropertiesUpdateAllOf".to_string())
            };
        ...
        std::result::Result::Ok(RemovePropertiesUpdateAllOf {
            removals: intermediate_rep.removals.into_iter().next().ok_or_else(|| "removals missing in RemovePropertiesUpdateAllOf".to_string())?,
        })
    }
}
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<header::IntoHeaderValue<RemovePropertiesUpdateAllOf>> for hyper::header::HeaderValue {
    type Error = String;

    fn try_from(hdr_value: header::IntoHeaderValue<RemovePropertiesUpdateAllOf>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for RemovePropertiesUpdateAllOf - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<RemovePropertiesUpdateAllOf> {
    type Error = String;
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <RemovePropertiesUpdateAllOf as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into RemovePropertiesUpdateAllOf - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl std::str::FromStr for RemoveSnapshotsUpdateAllOf {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing RemoveSnapshotsUpdateAllOf".to_string())
            };
        ...
        std::result::Result::Ok(RemoveSnapshotsUpdateAllOf {
            snapshot_ids: intermediate_rep.snapshot_ids.into_iter().next().ok_or_else(|| "snapshot-ids missing in RemoveSnapshotsUpdateAllOf".to_string())?,
        })
    }
}
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<header::IntoHeaderValue<RemoveSnapshotsUpdateAllOf>> for hyper::header::HeaderValue {
    type Error = String;

    fn try_from(hdr_value: header::IntoHeaderValue<RemoveSnapshotsUpdateAllOf>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for RemoveSnapshotsUpdateAllOf - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<RemoveSnapshotsUpdateAllOf> {
    type Error = String;
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <RemoveSnapshotsUpdateAllOf as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into RemoveSnapshotsUpdateAllOf - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl ReportMetricsRequest {
    #[allow(clippy::new_without_default)]
    pub fn new(report_type: String, table_name: String, snapshot_id: i64, filter: models::Expression, projection: models::Schema, metrics: std::collections::HashMap<String, models::MetricResult>, ) -> ReportMetricsRequest {
...
impl std::str::FromStr for ReportMetricsRequest {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        std::result::Result::Ok(ReportMetricsRequest {
            ...
            projection: intermediate_rep.projection.into_iter().next().ok_or_else(|| "projection missing in ReportMetricsRequest".to_string())?,
...
impl ScanReport {
    #[allow(clippy::new_without_default)]
    pub fn new(table_name: String, snapshot_id: i64, filter: models::Expression, projection: models::Schema, metrics: std::collections::HashMap<String, models::MetricResult>, ) -> ScanReport {
        ScanReport {
            table_name,
            snapshot_id,
            filter,
...
impl std::str::FromStr for ScanReport {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        std::result::Result::Ok(ScanReport {
            ...
            projection: intermediate_rep.projection.into_iter().next().ok_or_else(|| "projection missing in ScanReport".to_string())?,
        ...
        while key_result.is_some() {
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    #[allow(clippy::redundant_clone)]
                    "schema-id" => intermediate_rep.schema_id.push(<isize as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
...
impl std::str::FromStr for SchemaAllOf {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing SchemaAllOf".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "schema-id" => intermediate_rep.schema_id.push(<isize as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    "identifier-field-ids" => return std::result::Result::Err("Parsing a container in this style is not supported in SchemaAllOf".to_string()),
                    _ => return std::result::Result::Err("Unexpected key while parsing SchemaAllOf".to_string())
                }
            }
...
impl std::convert::TryFrom<header::IntoHeaderValue<SchemaAllOf>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<SchemaAllOf>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for SchemaAllOf - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <SchemaAllOf as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into SchemaAllOf - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl std::str::FromStr for SetCurrentSchemaUpdateAllOf {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing SetCurrentSchemaUpdateAllOf".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "schema-id" => intermediate_rep.schema_id.push(<isize as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing SetCurrentSchemaUpdateAllOf".to_string())
                }
            }
        ...
        std::result::Result::Ok(SetCurrentSchemaUpdateAllOf {
            schema_id: intermediate_rep.schema_id.into_iter().next().ok_or_else(|| "schema-id missing in SetCurrentSchemaUpdateAllOf".to_string())?,
        })
    }
}
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<header::IntoHeaderValue<SetCurrentSchemaUpdateAllOf>> for hyper::header::HeaderValue {
    type Error = String;

    fn try_from(hdr_value: header::IntoHeaderValue<SetCurrentSchemaUpdateAllOf>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for SetCurrentSchemaUpdateAllOf - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<SetCurrentSchemaUpdateAllOf> {
    type Error = String;
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <SetCurrentSchemaUpdateAllOf as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into SetCurrentSchemaUpdateAllOf - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
        ...
        while key_result.is_some() {
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    "action" => intermediate_rep.action.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "sort-order-id" => intermediate_rep.sort_order_id.push(<isize as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
...
impl std::str::FromStr for SetDefaultSortOrderUpdateAllOf {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing SetDefaultSortOrderUpdateAllOf".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "sort-order-id" => intermediate_rep.sort_order_id.push(<isize as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing SetDefaultSortOrderUpdateAllOf".to_string())
                }
            }
        ...
        std::result::Result::Ok(SetDefaultSortOrderUpdateAllOf {
            sort_order_id: intermediate_rep.sort_order_id.into_iter().next().ok_or_else(|| "sort-order-id missing in SetDefaultSortOrderUpdateAllOf".to_string())?,
        })
    }
}
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<header::IntoHeaderValue<SetDefaultSortOrderUpdateAllOf>> for hyper::header::HeaderValue {
    type Error = String;

    fn try_from(hdr_value: header::IntoHeaderValue<SetDefaultSortOrderUpdateAllOf>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for SetDefaultSortOrderUpdateAllOf - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<SetDefaultSortOrderUpdateAllOf> {
    type Error = String;
...
impl std::str::FromStr for SetDefaultSpecUpdateAllOf {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing SetDefaultSpecUpdateAllOf".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "spec-id" => intermediate_rep.spec_id.push(<isize as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing SetDefaultSpecUpdateAllOf".to_string())
                }
            }
        ...
        std::result::Result::Ok(SetDefaultSpecUpdateAllOf {
            spec_id: intermediate_rep.spec_id.into_iter().next().ok_or_else(|| "spec-id missing in SetDefaultSpecUpdateAllOf".to_string())?,
        })
    }
}
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<header::IntoHeaderValue<SetDefaultSpecUpdateAllOf>> for hyper::header::HeaderValue {
    type Error = String;

    fn try_from(hdr_value: header::IntoHeaderValue<SetDefaultSpecUpdateAllOf>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for SetDefaultSpecUpdateAllOf - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<SetDefaultSpecUpdateAllOf> {
    type Error = String;
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <SetDefaultSpecUpdateAllOf as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into SetDefaultSpecUpdateAllOf - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl std::str::FromStr for SetLocationUpdateAllOf {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing SetLocationUpdateAllOf".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "location" => intermediate_rep.location.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing SetLocationUpdateAllOf".to_string())
                }
            }
        ...
        std::result::Result::Ok(SetLocationUpdateAllOf {
            location: intermediate_rep.location.into_iter().next().ok_or_else(|| "location missing in SetLocationUpdateAllOf".to_string())?,
        })
    }
}
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<header::IntoHeaderValue<SetLocationUpdateAllOf>> for hyper::header::HeaderValue {
    type Error = String;

    fn try_from(hdr_value: header::IntoHeaderValue<SetLocationUpdateAllOf>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for SetLocationUpdateAllOf - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<SetLocationUpdateAllOf> {
    type Error = String;
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <SetLocationUpdateAllOf as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into SetLocationUpdateAllOf - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl std::str::FromStr for SetPropertiesUpdateAllOf {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing SetPropertiesUpdateAllOf".to_string())
            };
        ...
        std::result::Result::Ok(SetPropertiesUpdateAllOf {
            updates: intermediate_rep.updates.into_iter().next().ok_or_else(|| "updates missing in SetPropertiesUpdateAllOf".to_string())?,
        })
    }
}
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<header::IntoHeaderValue<SetPropertiesUpdateAllOf>> for hyper::header::HeaderValue {
    type Error = String;

    fn try_from(hdr_value: header::IntoHeaderValue<SetPropertiesUpdateAllOf>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for SetPropertiesUpdateAllOf - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<SetPropertiesUpdateAllOf> {
    type Error = String;
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <SetPropertiesUpdateAllOf as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into SetPropertiesUpdateAllOf - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl SetSnapshotRefUpdate {
    #[allow(clippy::new_without_default)]
    pub fn new(action: String, r#type: String, snapshot_id: i64, ref_name: String, ) -> SetSnapshotRefUpdate {
        ...
        while key_result.is_some() {
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    #[allow(clippy::redundant_clone)]
                    "min-snapshots-to-keep" => intermediate_rep.min_snapshots_to_keep.push(<isize as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "ref-name" => intermediate_rep.ref_name.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
...
impl std::str::FromStr for SetSnapshotRefUpdateAllOf {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing SetSnapshotRefUpdateAllOf".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "ref-name" => intermediate_rep.ref_name.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing SetSnapshotRefUpdateAllOf".to_string())
                }
            }
        ...
        std::result::Result::Ok(SetSnapshotRefUpdateAllOf {
            ref_name: intermediate_rep.ref_name.into_iter().next().ok_or_else(|| "ref-name missing in SetSnapshotRefUpdateAllOf".to_string())?,
        })
    }
}
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<header::IntoHeaderValue<SetSnapshotRefUpdateAllOf>> for hyper::header::HeaderValue {
    type Error = String;

    fn try_from(hdr_value: header::IntoHeaderValue<SetSnapshotRefUpdateAllOf>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for SetSnapshotRefUpdateAllOf - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<SetSnapshotRefUpdateAllOf> {
    type Error = String;
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <SetSnapshotRefUpdateAllOf as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into SetSnapshotRefUpdateAllOf - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl Snapshot {
    #[allow(clippy::new_without_default)]
    pub fn new(snapshot_id: isize, timestamp_ms: isize, manifest_list: String, summary: models::SnapshotSummary, ) -> Snapshot {
        Snapshot {
            snapshot_id,
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "snapshot-id" => intermediate_rep.snapshot_id.push(<isize as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "parent-snapshot-id" => intermediate_rep.parent_snapshot_id.push(<isize as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "sequence-number" => intermediate_rep.sequence_number.push(<isize as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "timestamp-ms" => intermediate_rep.timestamp_ms.push(<isize as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
...
impl std::string::ToString for SnapshotSummary {
    fn to_string(&self) -> String {
        let params: Vec<Option<String>> = vec![
            ...
            self.additional_properties.as_ref().map(|additional_properties| {
                vec![
        ...
        while key_result.is_some() {
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    #[allow(clippy::redundant_clone)]
                    "additionalProperties" => intermediate_rep.additional_properties.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
...
impl SortField {
    #[allow(clippy::new_without_default)]
    pub fn new(source_id: isize, transform: String, direction: models::SortDirection, null_order: models::NullOrder, ) -> SortField {
        SortField {
            source_id,
            transform,
            direction,
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "order-id" => intermediate_rep.order_id.push(<isize as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "id" => intermediate_rep.id.push(<isize as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "name" => intermediate_rep.name.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
        ...
        while key_result.is_some() {
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    "location" => intermediate_rep.location.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "last-updated-ms" => intermediate_rep.last_updated_ms.push(<isize as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    ...
                    #[allow(clippy::redundant_clone)]
                    "current-schema-id" => intermediate_rep.current_schema_id.push(<isize as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "last-column-id" => intermediate_rep.last_column_id.push(<isize as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    ...
                    #[allow(clippy::redundant_clone)]
                    "default-spec-id" => intermediate_rep.default_spec_id.push(<isize as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "last-partition-id" => intermediate_rep.last_partition_id.push(<isize as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    "sort-orders" => return std::result::Result::Err("Parsing a container in this style is not supported in TableMetadata".to_string()),
                    #[allow(clippy::redundant_clone)]
                    "default-sort-order-id" => intermediate_rep.default_sort_order_id.push(<isize as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    ...
                    #[allow(clippy::redundant_clone)]
                    "current-snapshot-id" => intermediate_rep.current_snapshot_id.push(<isize as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
...
impl std::string::ToString for TableRequirement {
    fn to_string(&self) -> String {
        let params: Vec<Option<String>> = vec![
            ...
            self.last_assigned_field_id.as_ref().map(|last_assigned_field_id| {
                vec![
            ...
            self.last_assigned_partition_id.as_ref().map(|last_assigned_partition_id| {
                vec![
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "requirement" => intermediate_rep.requirement.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    ...
                    "snapshot-id" => intermediate_rep.snapshot_id.push(<i64 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "last-assigned-field-id" => intermediate_rep.last_assigned_field_id.push(<isize as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "current-schema-id" => intermediate_rep.current_schema_id.push(<isize as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "last-assigned-partition-id" => intermediate_rep.last_assigned_partition_id.push(<isize as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "default-spec-id" => intermediate_rep.default_spec_id.push(<isize as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "default-sort-order-id" => intermediate_rep.default_sort_order_id.push(<isize as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
        ...
        std::result::Result::Ok(TableRequirement {
            requirement: intermediate_rep.requirement.into_iter().next().ok_or_else(|| "requirement missing in TableRequirement".to_string())?,
            ...
            current_schema_id: intermediate_rep.current_schema_id.into_iter().next(),
            last_assigned_partition_id: intermediate_rep.last_assigned_partition_id.into_iter().next(),
            default_spec_id: intermediate_rep.default_spec_id.into_iter().next(),
            default_sort_order_id: intermediate_rep.default_sort_order_id.into_iter().next(),
        })
    }
...
impl TableUpdate {
    #[allow(clippy::new_without_default)]
    pub fn new(action: String, format_version: isize, schema: models::Schema, schema_id: isize, spec: models::PartitionSpec, spec_id: isize, sort_order: models::SortOrder, sort_order_id: isize, snapshot: models::Snapshot, r#type: String, snapshot_id: i64, ref_name: String, snapshot_ids: Vec<i64>, location: String, updates: std::collections::HashMap<String, String>, removals: Vec<String>, ) -> TableUpdate {
        TableUpdate {
            action,
            format_version,
            schema,
...
impl std::str::FromStr for TableUpdate {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    "action" => intermediate_rep.action.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "format-version" => intermediate_rep.format_version.push(<isize as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "schema" => intermediate_rep.schema.push(<models::Schema as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "schema-id" => intermediate_rep.schema_id.push(<isize as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    ...
                    #[allow(clippy::redundant_clone)]
                    "ref-name" => intermediate_rep.ref_name.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    "snapshot-ids" => return std::result::Result::Err("Parsing a container in this style is not supported in TableUpdate".to_string()),
                    #[allow(clippy::redundant_clone)]
                    "location" => intermediate_rep.location.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    "updates" => return std::result::Result::Err("Parsing a container in this style is not supported in TableUpdate".to_string()),
                    "removals" => return std::result::Result::Err("Parsing a container in this style is not supported in TableUpdate".to_string()),
        ...
        std::result::Result::Ok(TableUpdate {
            ...
            format_version: intermediate_rep.format_version.into_iter().next().ok_or_else(|| "format-version missing in TableUpdate".to_string())?,
            schema: intermediate_rep.schema.into_iter().next().ok_or_else(|| "schema missing in TableUpdate".to_string())?,
            schema_id: intermediate_rep.schema_id.into_iter().next().ok_or_else(|| "schema-id missing in TableUpdate".to_string())?,
            spec: intermediate_rep.spec.into_iter().next().ok_or_else(|| "spec missing in TableUpdate".to_string())?,
            spec_id: intermediate_rep.spec_id.into_iter().next().ok_or_else(|| "spec-id missing in TableUpdate".to_string())?,
            sort_order: intermediate_rep.sort_order.into_iter().next().ok_or_else(|| "sort-order missing in TableUpdate".to_string())?,
            sort_order_id: intermediate_rep.sort_order_id.into_iter().next().ok_or_else(|| "sort-order-id missing in TableUpdate".to_string())?,
            snapshot: intermediate_rep.snapshot.into_iter().next().ok_or_else(|| "snapshot missing in TableUpdate".to_string())?,
            ...
            max_snapshot_age_ms: intermediate_rep.max_snapshot_age_ms.into_iter().next(),
            min_snapshots_to_keep: intermediate_rep.min_snapshots_to_keep.into_iter().next(),
            ref_name: intermediate_rep.ref_name.into_iter().next().ok_or_else(|| "ref-name missing in TableUpdate".to_string())?,
            snapshot_ids: intermediate_rep.snapshot_ids.into_iter().next().ok_or_else(|| "snapshot-ids missing in TableUpdate".to_string())?,
            location: intermediate_rep.location.into_iter().next().ok_or_else(|| "location missing in TableUpdate".to_string())?,
            updates: intermediate_rep.updates.into_iter().next().ok_or_else(|| "updates missing in TableUpdate".to_string())?,
            removals: intermediate_rep.removals.into_iter().next().ok_or_else(|| "removals missing in TableUpdate".to_string())?,
        })
    }
}
...
impl Type {
    #[allow(clippy::new_without_default)]
    pub fn new(r#type: String, fields: Vec<models::StructField>, element_id: isize, element: models::Type, element_required: bool, key_id: isize, key: models::Type, value_id: isize, value: models::Type, value_required: bool, ) -> Type {
        Type {
            r#type,
            fields,
            element_id,
    ...
    fn to_string(&self) -> String {
        let params: Vec<Option<String>> = vec![
            ...
            self.updates.as_ref().map(|updates| {
                vec![
                    "updates".to_string(),
                    updates.iter().map(|x| x.to_string()).collect::<Vec<_>>().join(","),
                ].join(",")
            }),
...
impl std::str::FromStr for UpdateProperties200Response {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing UpdateProperties200Response".to_string())
            };
        ...
        std::result::Result::Ok(UpdateProperties200Response {
            updated: intermediate_rep.updated.into_iter().next().ok_or_else(|| "updated missing in UpdateProperties200Response".to_string())?,
            removed: intermediate_rep.removed.into_iter().next().ok_or_else(|| "removed missing in UpdateProperties200Response".to_string())?,
            missing: std::result::Result::Err("Nullable types not supported in UpdateProperties200Response".to_string())?,
        })
    }
}
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<header::IntoHeaderValue<UpdateProperties200Response>> for hyper::header::HeaderValue {
    type Error = String;

    fn try_from(hdr_value: header::IntoHeaderValue<UpdateProperties200Response>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for UpdateProperties200Response - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<UpdateProperties200Response> {
    type Error = String;
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <UpdateProperties200Response as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into UpdateProperties200Response - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl UpdateTable200Response {
    #[allow(clippy::new_without_default)]
    pub fn new(metadata_location: String, metadata: models::TableMetadata, ) -> UpdateTable200Response {
...
impl std::str::FromStr for UpdateTable200Response {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing UpdateTable200Response".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    #[allow(clippy::redundant_clone)]
                    "metadata" => intermediate_rep.metadata.push(<models::TableMetadata as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing UpdateTable200Response".to_string())
                }
            }
        ...
        std::result::Result::Ok(UpdateTable200Response {
            metadata_location: intermediate_rep.metadata_location.into_iter().next().ok_or_else(|| "metadata-location missing in UpdateTable200Response".to_string())?,
            metadata: intermediate_rep.metadata.into_iter().next().ok_or_else(|| "metadata missing in UpdateTable200Response".to_string())?,
        })
    }
}
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<header::IntoHeaderValue<UpdateTable200Response>> for hyper::header::HeaderValue {
    type Error = String;

    fn try_from(hdr_value: header::IntoHeaderValue<UpdateTable200Response>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for UpdateTable200Response - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<UpdateTable200Response> {
    type Error = String;
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <UpdateTable200Response as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into UpdateTable200Response - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl std::str::FromStr for UpgradeFormatVersionUpdateAllOf {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing UpgradeFormatVersionUpdateAllOf".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "format-version" => intermediate_rep.format_version.push(<isize as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing UpgradeFormatVersionUpdateAllOf".to_string())
                }
            }
        ...
        std::result::Result::Ok(UpgradeFormatVersionUpdateAllOf {
            format_version: intermediate_rep.format_version.into_iter().next().ok_or_else(|| "format-version missing in UpgradeFormatVersionUpdateAllOf".to_string())?,
        })
    }
}
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<header::IntoHeaderValue<UpgradeFormatVersionUpdateAllOf>> for hyper::header::HeaderValue {
    type Error = String;

    fn try_from(hdr_value: header::IntoHeaderValue<UpgradeFormatVersionUpdateAllOf>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<UpgradeFormatVersionUpdateAllOf> {
    type Error = String;
